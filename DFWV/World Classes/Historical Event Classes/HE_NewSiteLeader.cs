...
namespace DFWV.WorldClasses.HistoricalEventClasses
{
    class HE_NewSiteLeader : HistoricalEvent
    {
        ...
        public int? NewLeaderHFID { get; set; }
        public HistoricalFigure NewLeaderHF { get; set; }
        ...
        internal override void Export(string table)
        {
            ...
            vals = new List<object>() { ID, SiteID, SiteCivID, DefenderCivID, NewSiteCivID, AttackerCivID, NewLeaderHFID };
