...
namespace DFWV.WorldClasses.HistoricalEventClasses
{
    class HE_Performance : HistoricalEvent
    {
        ...
        protected override string LegendsDescription()
        {
            ...
            return
                $"{timestring} {Entity} held a performance of UNKNOWN in {Site.AltName} as part of {EventCollection.Name ?? "UNKNOWN"}.";
        ...
        internal override string ToTimelineString()
        {
            ...
            return $"{timelinestring} {Entity} held a performance in {Site.AltName}.";
